...
{
    public class GenericPublicRepository<T> : IGenericRepository<T> where T : class
    {
        protected readonly ZeusPublicContext _context;
        public GenericPublicRepository(ZeusPublicContext context)
        {
            _context = context;
        }
