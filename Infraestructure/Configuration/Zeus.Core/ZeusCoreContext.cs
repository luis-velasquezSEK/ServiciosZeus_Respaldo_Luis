...
public partial class ZeusCoreContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Empleado>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPaisNacNavigation).WithMany(p => p.Empleados)
        ...
        modelBuilder.Entity<Horario>(entity =>
        {
            ...
            entity.HasOne(d => d.IdPlanificacionNavigation).WithMany()
                .HasPrincipalKey(p => p.IdPlanificacion)
        ...
        modelBuilder.Entity<Materium>(entity =>
        {
            ...
            entity.HasOne(d => d.IdTipoMateriaCatalogoNavigation).WithMany(p => p.Materia)
                .HasForeignKey(d => d.IdTipoMateriaCatalogo)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__MATERIA__ID_TIPO__3F9B6DFF");
        ...
        {
            entity.HasKey(e => new { e.IdMalla, e.IdMateria, e.IdNivelEstudio, e.IdPlanEstudio, e.IdPeriodo, e.IdPeriodicidad, e.IdTipoPeriodo, e.IdModalidad, e.IdEstadoPeriodo, e.IdModalidadPlanificacion, e.IdPeriodicidadPlanificacion, e.IdTipoComponente, e.Paralelo, e.IdEspaciosFisicos }).IsClustered(false);

            entity.ToTable("PLANIFICACION");

            entity.HasIndex(e => e.IdPlanificacion, "IX_PLANIFICACION").IsUnique();
            ...
            entity.HasOne(d => d.Componente).WithMany(p => p.Planificacions)
                .HasForeignKey(d => new { d.IdPlanEstudio, d.IdMateria, d.IdTipoComponente })
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_PLANIFICACION_COMPONENTE");
        ...
        modelBuilder.Entity<PruebaEdi>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("pruebaEdi", tb =>
                {
                    tb.HasTrigger("actualizaprueba");
                    tb.HasTrigger("crearprueba");
                });
